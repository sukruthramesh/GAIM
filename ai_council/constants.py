...
ONLINE_MODLES =[
    {"id" : "expert_1", "llm" : ChatOpenAI(model="gpt-4.0"), "name" : "deepseek-r1:8b"},
    {"id" : "expert_2", "llm" : ChatOpenAI(model="starling-lm"), "name" : "starling-1m"},
    {"id" : "expert_3", "llm" : ChatOpenAI(model="ministral-3"), "name" : "minstral-3"},
    ...
    {"id" : "evaluator", "llm" : ChatOpenAI(model="gemma2:9b"), "name": "gemma2:9b"},
...
VECTOR_DB_FOLDER = "ai_council/Vectors"